...
import { Alert, ImageBackground, SafeAreaView, Text, TextInput, View} from 'react-native';
...
const RegisterScreen = () => {
  ...
  return (
    ...
    <ImageBackground
      ...
      <View>
        <View style={{position: 'absolute', marginTop: 1, marginLeft: SPACING.h10, zIndex: 4, backgroundColor: 'white'}}>
        <Text >Mobile Phone</Text>
              ...
              {/* <LoginScreenLabelText>Mobile Phone</LoginScreenLabelText>
                ...
                <SignUpScreenTouchableWrapper onPress={onSubmit}>
                    <ReUsableButton title="Submit" color={mainBackgroundColor} />
                </SignUpScreenTouchableWrapper>
                </View>
    ...
    <AlertModal visible={modalVisible} onClose={() =>  {
